...
//
//
// $Id: WaterCherenkovRunMessenger.cc,v 1.3 2006/06/29 17:54:29 gunter Exp $
...
WaterCherenkovRunMessenger::WaterCherenkovRunMessenger(
                                          WaterCherenkovRunAction* WaterCherenkovRun)
:fRunAction(WaterCherenkovRun)
{
  fFileNameDir = new G4UIdirectory("/WaterCherenkov/fileName/");
  fFileNameDir->SetGuidance("Run filename control");
...
void WaterCherenkovRunMessenger::SetNewValue(
