...
// ------------ Generate & Add Material Properties Table ------------ //
  ...
  G4double RefractiveIndex1[nEntries] = {1.3, 1.3};
  ...
  G4double Absorption1[nEntries] = {45.455*m, 45.455*m};
...
// Glass Disk Surface
  ...
  G4double reflectivity2[nEntries] = {fReflectivity2, fReflectivity2};
